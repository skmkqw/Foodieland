...
export default function RecipeInfoBar({ timeToCook, category, creatorName, creationDate, userImage }: {
    timeToCook: number,
    category: string,
    creatorName: string,
    creationDate: string,
    ...
    return (
        <div className="grid grid-cols-3 sm:flex items-center gap-6">
            <CreatorInfo image={userImage} name={creatorName} creationDate={creationDate}
                         className="sm:pr-4 sm:flex-row flex-col" />
            <div
                className="flex sm:flex-row flex-col items-center gap-4 px-6 border-l-2 border-l-gray-400 border-r-2 border-r-gray-400">
