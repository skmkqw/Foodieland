import { Button, Container, Description, Title } from "@/components";
...
export default function Inbox() {
    return (
        <Container className="w-full">
            <div
                className="relative flex flex-col items-center justify-center p-12 gap-10 bg-primary rounded-3xl text-center">
                ...
                <Description
                    ...
                    className="max-w-2xl" />
                <form
                    className="flex flex-col base:flex-row items-stretch justify-center gap-5 p-4 bg-white mt-4 rounded-3xl mb-10 z-10">
                    <input type="email" placeholder="Your email address..." className="border-none" />
                    <Button type="submit" text="Subscribe" />
                </form>
                <Image src="/inbox-left.png" alt="Food" height={300} width={300}
                       className="absolute bottom-0 left-0 w-80" />
                <Image src="/inbox-right.png" alt="Food" height={250} width={250}
